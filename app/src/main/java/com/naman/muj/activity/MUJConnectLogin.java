...
import com.naman.muj.parseUtils.ParseUtils;
import com.naman.muj.parseUtils.PrefManager;

import static com.naman.muj.parseUtils.ParseUtils.subscribeWithEmail;

/**
 * A login screen that offers login via email/password.
 */
public class MUJConnectLogin extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mujconnect_login);
    ...
    private void attemptLogin() {
        ...
        String imei = getDevice();
        boolean cancel = false;
        View focusView = null;

        // Implement any errors //
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            subscribeWithEmail(mEmail,mPassword,imei);
            return true;
        }
